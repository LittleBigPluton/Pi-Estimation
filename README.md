...
The accuracy of the Monte Carlo estimation improves with the number of samples N. As N increases, the ratio $\frac{N_{\text{inside}}}{N}$ converges to the true probability $\frac{\pi}{4}$ (by the law of large numbers)[2], leading to an increasingly accurate approximation of $\pi$.
...
[4]:https://en.wikipedia.org/wiki/Pi#Rate_of_convergence
[5]:https://en.wikipedia.org/wiki/Gauss%E2%80%93Legendre_algorithm
